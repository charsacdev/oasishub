<div>
    {{-- The best athlete wants his opponent at his best. --}}
        ...
        <div class="wpo-breadcumb-area" style="height:600px !important;background: url('{{ asset('assets/images/flightjet.jpg') }}') no-repeat center center/cover !important;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="wpo-breadcumb-wrap">
                            ...
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li><span>Luxury Flights</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
