<div>
     <!-- start of breadcumb-section -->
        <div class="wpo-breadcumb-area" style="height:600px;background: url('{{ asset('assets/images/luxcars.jpg') }}') no-repeat center center/cover !important;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
